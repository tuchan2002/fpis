            ...
            <Paper sx={{ p: 3, maxWidth: 720, width: "100%" }}>
                ...
                >
                    ...
                    {showQRcode && (
                        ...
                        <div ref={qrCodeRef} style={{width: 180, height: 180, display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                            <QRCode value={JSON.stringify(productInputData)} size={160} />
                        </div>
